...
//
//                 // ИСПРАВЛЕНИЕ 1: Даты на уровне проекта
//                 if (!parsedProject.start) {
//                     parsedProject.start = defaultTimelineRange.start;
//                     projectUpdated = true;
//                 }
//                 if (!parsedProject.end) {
//                     parsedProject.end = defaultTimelineRange.end;
//                     projectUpdated = true;
//                 }
//
//                 // ИСПРАВЛЕНИЕ 2: Миграция старых данных
//                 // Если даты были в timeline, переносим их на уровень проекта
//                 if (parsedProject.timeline) {
//                     if (parsedProject.timeline.start && !parsedProject.start) {
//                         parsedProject.start = parsedProject.timeline.start;
//                         projectUpdated = true;
//                     }
//                     if (parsedProject.timeline.end && !parsedProject.end) {
//                         parsedProject.end = parsedProject.timeline.end;
//                         projectUpdated = true;
//                     }
//                 }
//
//                 // Инициализация timeline (без start/end!)
//                 if (!parsedProject.timeline) {
...
//
//                     // Убираем start/end из timeline если они там есть
//                     if (timeline.start !== undefined || timeline.end !== undefined) {
//                         delete timeline.start;
//                         delete timeline.end;
//                         projectUpdated = true;
//                     }
//
...
//         return new Promise((resolve) => {
//             // ИСПРАВЛЕНИЕ 3: Убеждаемся что start/end на уровне проекта
//             const projectToSave = {
//                 ...projectData,
//                 start: projectData.start || projectData.timeline?.start,
//                 end: projectData.end || projectData.timeline?.end
//             };
//
//             // Убираем start/end из timeline
...
//             const defaultTimelineRange = getDefaultTimelineRange();
//
//             // ИСПРАВЛЕНИЕ 4: Даты на уровне проекта, не в timeline
//             const newProject = {
//                 ...projectData,
//                 start: projectData.start || defaultTimelineRange.start,  // ← На уровне проекта!
//                 end: projectData.end || defaultTimelineRange.end,        // ← На уровне проекта!
//                 assemblyTypes: [],
//                 componentTypes: [],
//                 partModels: [],
//                 nodes: [],
//                 timeline: {
//                     // start и end НЕ включаем!
//                     assemblyStates: [],
//                     unitAssignments: [],
//                     maintenanceEvents: []
//                 }
...
import { mockProjects, mockStructureTree } from '../data/mockData'; // Assuming mockData file exists
